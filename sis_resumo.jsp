...
<tr>
 ...
 <table align="center" width="900" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="<%=cor[j]%>">
   ...
   <td align="left"><%=rs01.getString("lancamentoID") %></td>
   <td colspan="2" align="left">
   <a href="sis_detalhe_receber.jsp?receberID=<%=rs01.getString("receberID") %>&servico=s" title="Informa&ccedil;&otilde;es sobre o Servi&ccedil;o">Contrato N&deg; 
   <%
   	//Recupera o ID do 
	servico.servicoID = rs01.getInt("vendaID");
   	//Pesquisa informações sobre o serviço
   	rs06 = st06.executeQuery(servico.pesquisaServico());
   	//Verifica se a pesquisa trouxe algum resultado
    if(rs06.next()){
    	out.println(rs06.getString("contrato")+"/"+rs06.getString("dataContrato").substring(0,4));
    }
   %>
    - 
   <%if(rs01.getString("formID").equals("4") || rs01.getString("formID").equals("5")){%>
