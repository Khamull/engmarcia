...
function verForm(){
	...
	//Atribui o valor de um campo ao outro para ser salvo
	document.form1.clienteCnpj.value = document.form1.clienteCpf.value; 
     ...
     <td valign="top">
      ...
      <table align="center">
       ...
       <tr>
        ...
        <td align="left"><input type="text" name="clienteInscMunicipal" id="clienteInscMunicipal" size="14" maxlength="14" style="width:120px" onKeyPress="return numero(this)" value="<%=rs.getString("clienteInscMunicipal")%>"></td>
       </tr>
       <tr>
