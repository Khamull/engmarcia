     ...
     <td valign="top">
      ...
      <table align="center">
       ...
       <tr>
        ...
        <td align="left"><input type="text" name="clienteInscMunicipal" id="clienteInscMunicipal" size="14" maxlength="14" style="width:120px" onKeyPress="return numero(this)" value="<%=rs.getString("clienteInscMunicipal")%>" readonly="readonly"></td>
       </tr>
       <tr>
