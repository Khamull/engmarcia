...
<%}%>
  ...
  <table width="720" align="center">
   <tr>
    ...
    <td width="160" align="center"><a href="sis_view_loja.jsp"><img src="ico/ico_store.png" width="60" height="60" border="0" title="Fornecedores" /></a></td>
    </tr>
   <tr>
   ...
   <tr>
	<td width="160" align="center"><a href="sis_menu_servicos.jsp"><img src="ico/ico_servico.png" alt="" width="60" height="60" border="0" title="Serviços" /></a></td>
...
history=yes,width = 880px; height = 600px')"><img src="ico/ico_nfe.png" alt="" width="60" height="60" border="0" title="Nota Fiscal Eletronica" /></a></td>
    <td width="160" align="center"><a href="sis_view_relatorios.jsp"><img src="ico/ico_relatorios.png" alt="" width="60" height="60" border="0" title="Relat&oacute;rios" /></a></td>
    <td width="160" align="center"><a href="sis_menu.jsp?sair=ok"><img src="ico/ico_sair.png" alt="" width="60" height="60" border="0" title="Sair do Sistema" /></a></td>
    </tr>
   <tr>
